...
Bundesland-Individuum: `lp:LP_3000031` — `von Bundesland` (LP_0000029) zeigt darauf.

Schulfach-IDs: Präfix `TH_` in `references/terms/sf-terms.tsv` (49 Einträge; Wurzel `TH_0000000`).
Schulart-IDs: Präfix `TH_` in `references/terms/sa-terms.tsv` (7 Einträge; Wurzel `TH_0000000`).

Achtung: Schulfach- und Schulart-IDs kollidieren im lokalen Namen (`TH_0000003` gibt es in beiden) — immer mit vollem Namensraum schreiben.
...
| ID | Bezeichnung |
|---|---|
| LP_0000309 | Regelschulniveau (TH) |
| LP_0000310 | Hauptschulabschlussbezogener Kurs (TH) |
| LP_0000311 | Realschulabschlussbezogener Kurs (TH) |
| LP_0000312 | Allgemeinbildender Schulabschluss (TH) |
| LP_0000313 | Hauptschulabschluss (TH) |
| LP_0000314 | Qualifizierender Hauptschulabschluss (TH) |
| LP_0000315 | Realschulabschluss (TH) |
| LP_0000528 | Grundlegendes Anforderungsniveau (TH) |
| LP_0000529 | Erhöhtes Anforderungsniveau (TH) |
| LP_0030358 | Gymnasialniveau Sek II (TH) |
| LP_0030359 | Gymnasialniveau Sek I (TH) |
| LP_0030376 | Grundschulniveau (TH) |
